...
export class SystemLogController {
  ...
  @Permissions(
    new PermissionEntity({ action: "GET", path: "/system-log/export" }),
  )
  ...
  @Permissions(
    new PermissionEntity({ action: "DELETE", path: "/system-log/clear" }),
  )
  ...
  @Get(":id")
  @ApiOkResponse({ type: SystemLogDetailResponseDto })
